...
# directory
cfg.DATASET.SOURCE_DIR = pathlib.Path('/'.join(str(path_root.resolve()).split('/')[:3])) / 'data/EndoVis17'
cfg.DATASET.TARGET_DIR = pathlib.Path('/'.join(str(path_root.resolve()).split('/')[:3])) / 'data/EndoVis18'
cfg.DATASET.PESUDO_DIR = '../../pseudo_label'
# data list
